...
class ServicesController extends BaseController
{
    ...
    public function index()
    {
        ...
        if(\request()->ajax()) {
            $services = $this->postRepository->findByDataTable('type','services','=');
            return DataTables::of($services)
                ...
                ->editColumn('service', function ($services) {
                    $url=asset($services->getServiceImage());
