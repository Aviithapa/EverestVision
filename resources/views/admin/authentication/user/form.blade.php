...
<div class="grid simple ">
    ...
    <div class="grid-body">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    {!! Form::label('nepali_name', 'Name in Nepali:', ['class' => 'form-label']) !!}
                    {!! Form::text('nepali_name', null, ['class' => 'form-control']) !!}
                    {!! $errors->first('nepali_name', '<div class="text-danger">:message</div>') !!}
                </div>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('email', null, ['class' => 'form-control','pattern'=>"([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{1,5}|[0-9]{1,3})(\]?)"]) !!}
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('phone_number', null, ['class' => 'form-control','pattern'=>'[0-9]{9,10}']) !!}
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('mobile_number', null, ['class' => 'form-control','pattern'=>'[0-9]{10}']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('contact_email', null, ['class' => 'form-control','pattern'=>"([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{1,5}|[0-9]{1,3})(\]?)"]) !!}
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('contact_phone_number', null, ['class' => 'form-control','pattern'=>'[0-9]{9,10}']) !!}
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('contact_mobile_number', null, ['class' => 'form-control','pattern'=>'[0-9]{10}']) !!}
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('company_registration_number', null, ['class' => 'form-control','pattern'=>'[0-9]{9}']) !!}
            ...
            <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    ...
                    {!! Form::text('vat_pan_no', null, ['class' => 'form-control','pattern'=>'[0-9]{9}']) !!}
