...
@section('content')
{{--    @include('admin.partials.common.page-title', ['page_title' => 'Welcome to FMCT Dashboard'])--}}
<h3 class="text-center"><span class="semi-bold">Welcome To Everest Vision Dashboard</span></h3>
{{--    <div>--}}
{{--        <div class="row 2col">--}}
