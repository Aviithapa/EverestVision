...
@section('content')
    @include('admin.partials.common.page-title', ['page_title' => $commonMessage.' Management'])
    <div>
        <div class="row-fluid">
            <div class="span12">
...
//                {data: 'status', name: 'status'},
                {className: 'td-actions', data: 'action', name: 'action', orderable: true, searchable: false}
            ]
        });
    </script>
@endpush
